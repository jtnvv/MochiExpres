...
export const deleteCliente = (req, res) => {
    ...
    jwt.verify(token, "jwtkey", (err, userInfo) => {
        ...
        db.query(q, [clienteId], (err, data) => {
            ...
            registrarOperacion(usuario_log.tipousuario, usuario_log.idusuario, usuario_log.nombreusuario,"DELETE","Cliente", clienteId, `El cliente con el identificador ${clienteId} fue borrado con éxito`, "Exitoso", new Date(), res);
