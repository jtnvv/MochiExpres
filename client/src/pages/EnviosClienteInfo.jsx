...
import { EnvClienteSeleccionado } from "./EnvClientes";
                    ...
                    <div className="modalEnvioContenedor">
                        <div className="Container2modalEnvio">
                            <div className="modalEnvioContenedor2">
                                <div className="id ">
                                    <div className="idEnvio card">34F</div>
                                ...
                                <div className="contenedorTarifaInfo">
                                    <div className="tarifaInfo">
                                        <div className="tarifaDescripcion ">
                                            <div className="tarifa card">$ 17000</div>
                                            <div className="Descripcion card">
                                                <h3>Descripcion paquete</h3>
                                                <textarea value="Envio 34F con caracteristicas tipo john doe y loremp impsum" disabled name="" id="" cols="50" rows="30" className="descripcionText">
                                                </textarea>
                                            </div>
                                        </div>
